...
namespace KancelarWeb
{
    ...
    public partial class UdalostClient
    {
        ...
        public System.Threading.Tasks.Task<Udalost> GetAsync(System.Guid? udalostId)
        {
            return GetAsync(udalostId, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Udalost> GetAsync(System.Guid? udalostId, System.Threading.CancellationToken cancellationToken)
        {
